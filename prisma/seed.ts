...
async function main() {
  ...
  await prisma.program.createMany({ data: [
    { id: "scratch-creativite", title: "Scratch & Créativité", ageRange: "7–10 ans", level: "debutant", description: "Jeux, histoires animées et premières notions d'algorithmique avec Scratch et Micro:bit.", tools: ["Scratch", "Micro:bit"], priceMonthly: 650, icon: "🧩", color: "accent", sortOrder: 1 },
    { id: "robotique-mbot", title: "Robotique mBot", ageRange: "10–14 ans", level: "intermediaire", description: "Capteurs, moteurs, logique robotique et préparation aux compétitions éducatives.", tools: ["mBot", "Arduino", "Thymio"], priceMonthly: 750, icon: "🤖", color: "cyan", sortOrder: 2 },
    { id: "arduino-iot", title: "Arduino & IoT", ageRange: "11–15 ans", level: "intermediaire", description: "Électronique, objets connectés, Raspberry Pi et prototypes intelligents.", tools: ["Arduino", "Raspberry Pi", "Dadabit AI"], priceMonthly: 850, icon: "💡", color: "amber", sortOrder: 3 },
    { id: "python-data", title: "Python & Data", ageRange: "12–16 ans", level: "avance", description: "Python moderne, données, visualisation et automatisation utile pour les adolescents.", tools: ["Python", "VS Code", "Pandas"], priceMonthly: 850, icon: "🐍", color: "green", sortOrder: 4 },
    { id: "web-development", title: "Web Development", ageRange: "13–17 ans", level: "avance", description: "Sites web, interfaces responsives, JavaScript et premières applications React.", tools: ["HTML/CSS", "JavaScript", "React"], priceMonthly: 900, icon: "🌐", color: "rose", sortOrder: 5 },
