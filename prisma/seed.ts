...
async function main() {
  ...
  await prisma.program.createMany({ data: [
    { id: "scratch-creativite", title: "Scratch & Créativité", ageRange: "7–10 ans", level: "debutant", description: "Jeux, histoires animées et premières notions d'algorithmique avec Scratch et Micro:bit.", tools: ["Scratch", "Micro:bit"], priceMonthly: 650, image: "/images/kid-elearning.jpg", color: "accent", categoryId: "cat-creativite", sortOrder: 1 },
    { id: "robotique-mbot", title: "Robotique mBot", ageRange: "10–14 ans", level: "intermediaire", description: "Capteurs, moteurs, logique robotique et préparation aux compétitions éducatives.", tools: ["mBot", "Arduino", "Thymio"], priceMonthly: 750, image: "/images/kids-stem.jpg", color: "cyan", categoryId: "cat-robotique", sortOrder: 2 },
    { id: "arduino-iot", title: "Arduino & IoT", ageRange: "11–15 ans", level: "intermediaire", description: "Électronique, objets connectés, Raspberry Pi et prototypes intelligents.", tools: ["Arduino", "Raspberry Pi", "Dadabit AI"], priceMonthly: 850, image: "/images/hero-mentoring.jpg", color: "amber", categoryId: "cat-iot", sortOrder: 3 },
    { id: "python-data", title: "Python & Data", ageRange: "12–16 ans", level: "avance", description: "Python moderne, données, visualisation et automatisation utile pour les adolescents.", tools: ["Python", "VS Code", "Pandas"], priceMonthly: 850, image: "/images/teacher-board.jpg", color: "green", categoryId: "cat-programmation", sortOrder: 4 },
    { id: "web-development", title: "Web Development", ageRange: "13–17 ans", level: "avance", description: "Sites web, interfaces responsives, JavaScript et premières applications React.", tools: ["HTML/CSS", "JavaScript", "React"], priceMonthly: 900, image: "/images/girl-writing.jpg", color: "rose", categoryId: "cat-web", sortOrder: 5 },
    { id: "intelligence-artificielle", title: "Intelligence Artificielle", ageRange: "14–17 ans", level: "avance", description: "Vision, machine learning, projets IA éducatifs et robotique VinciBot.", tools: ["VinciBot", "Dadabit AI", "Python ML"], priceMonthly: 950, image: "/images/hero-family.jpg", color: "purple", categoryId: "cat-ia", sortOrder: 6 },
  ]});
