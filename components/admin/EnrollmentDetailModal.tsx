      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-3">
            <div className="flex size-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-sky to-cyan text-sm font-black text-white">
              {initials}
            </div>
            <div className="min-w-0">
              <span className="block break-words text-lg">{request.studentFirstName} {request.studentLastName}</span>
        ...
        <div className="space-y-5">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-xl bg-surface p-4">
              ...
              <div className="flex items-center gap-2 mt-2 text-sm">
                <CalendarBlank className="size-3.5 text-ink-soft shrink-0" />
          ...
          <div className="rounded-xl bg-surface p-4">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              ...
              <div className="flex min-w-0 items-center gap-2 text-sm">
                <EnvelopeSimple className="size-3.5 text-ink-soft shrink-0" />
                <span className="min-w-0 flex-1 truncate text-ink-soft">{request.parentEmail}</span>
              </div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-2 rounded-xl bg-surface px-4 py-3">
            <span className="min-w-0 truncate text-xs text-ink-soft font-medium">
