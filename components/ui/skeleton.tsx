export function Skeleton({ className = "" }: { className?: string }) {
  return <div className={`animate-pulse rounded-brand-sm bg-ink-soft/10 ${className}`} />;
}

export function StatCardSkeleton() {
  return (
    <div className="rounded-brand border-2 border-border bg-white dark:bg-surface p-5">
...
export function ListItemSkeleton() {
  return (
    <div className="flex items-center justify-between rounded-brand-sm border-2 border-border bg-white dark:bg-surface px-4 py-3">
