        ...
        <div className="grid gap-8 sm:gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2">
              ...
              <Link href="/blog" className="text-sm text-ink-soft transition hover:text-brand">Blog</Link>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <span className="flex items-center gap-2 text-sm text-ink-soft">
                <MapPin className="size-4" /> Avenue Hassan II, Marrakech, Maroc
              </span>
              <div className="mt-2 flex gap-2">
                <a
                  href="tel:+212600000000"
                  suppressHydrationWarning
                  className="inline-flex items-center gap-2 rounded-full border-2 border-brand/30 bg-brand/10 px-4 py-2 text-xs font-bold text-brand transition hover:bg-brand hover:text-white"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 rounded-full border-2 border-[#25D366]/30 bg-[#25D366]/10 px-4 py-2 text-xs font-bold text-[#25D366] transition hover:bg-[#25D366] hover:text-white"
                >
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-sm text-ink-soft">
              ...
              <span>Samedi : 9h30 – 18h30</span>
              <span>Dimanche : 9h30 – 18h30</span>
            </div>
          </div>
        </div>
