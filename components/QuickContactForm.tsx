  ...
  return (
    <form onSubmit={onSubmit} className="card p-6">
      ...
      <div className="mt-5 grid gap-3">
        ...
        <textarea name="message" className="min-h-24 rounded-brand-sm border-2 border-border bg-surface px-4 py-3 text-sm text-ink outline-none focus:border-accent focus:ring-4 focus:ring-accent/15 placeholder:text-ink-soft/50" placeholder="Votre question…" />
      </div>
