        ...
        {filters.map((f) => (
          <button
            ...
            className={`whitespace-nowrap rounded-full px-4 py-2 text-sm font-bold transition ${
              filter === f.key ? "bg-sky text-white" : "bg-white border-2 border-[#E8EEF6] text-ink-soft hover:border-sky"
            }`}
          >
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {filtered.map((req) => {
            ...
            return (
              <div key={req.id} className="rounded-brand border-2 border-[#E8EEF6] bg-white overflow-hidden">
                <button
                ...
                {isOpen && (
                  <div className="px-6 pb-6 border-t-2 border-[#E8EEF6] pt-4 space-y-3">
