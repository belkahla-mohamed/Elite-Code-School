...
### [x] T5.1 — Create Home page (`app/page.tsx`)
...
### [x] T5.2 — Create About page (`app/about/page.tsx`)
- School mission and vision
- Teaching approach (project-based, age-appropriate)
- Team/staff section (placeholder)
- Facilities information

### [x] T5.3 — Create Curricula catalog (`app/curricula/page.tsx`)
...
### [x] T5.4 — Create Curriculum Detail page (`app/curricula/[id]/page.tsx`)
...
### [x] T5.5 — Create Public Portfolios grid (`app/portfolios/page.tsx`)
...
### [x] T5.6 — Create Portfolio Detail page (`app/portfolios/[id]/page.tsx`)
...
### [x] T5.7 — Create Contact page (`app/contact/page.tsx`)
- School contact information (email, phone, address)
- Contact form (name, email, message)
- Embedded map placeholder

### [x] T5.8 — Create API routes for public data
...
### [x] T5.9 — Add SEO metadata to all public pages
