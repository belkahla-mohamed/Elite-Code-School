...
### [ ] T7.1 — Create Auth utilities (`lib/auth.ts`)
...
### [ ] T7.2 — Create Auth middleware (`lib/middleware.ts`)
...
### [ ] T7.3 — Create Parent login page (`app/parent/login/page.tsx`)
...
### [ ] T7.4 — Create Parent login API (`POST /api/auth/parent/login`)
...
### [ ] T7.5 — Create Admin login page (`app/admin/login/page.tsx`)
...
### [ ] T7.6 — Create Admin login API (`POST /api/auth/admin/login`)
...
### [ ] T7.7 — Create Auth context provider (`lib/auth-context.tsx`)
...
### [ ] T7.8 — Create ProtectedRoute / AuthGuard components
...
### [ ] T7.9 — Create Logout functionality
- Clear JWT from storage
- Redirect to home page
- Show toast: "You have been logged out."

### [ ] T7.10 — Create password reset flow for Admin (optional)
